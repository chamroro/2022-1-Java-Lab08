...
/** 
 * The class that receives the calculation from the command line and executes the function for each case
 *
 * ex) java -cp classes edu/handong/csee/java/hw2/MathDriver HE Square 4
 * 
 * @author  Haeun Kim
 */  
...
public class MathDriver{
    ...
    /** 
     * Create MathDrive method and call a run method
     */
    ...
    /** 
     * Run method that executes the function for each case
     */
    public void run(String[] args){
        ...
        switch(args[1]){
            case "Max":
                System.out.println("Driver Name: "+mathCalculator.getName()+", Answer: "
